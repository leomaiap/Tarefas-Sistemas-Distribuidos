...
class UpdateTask extends StatefulWidget {
  ...
  UpdateTask({super.key, required this.color, required this.nome, required this.startTime, required this.endTime, required this.date, required this.note, required this.taskId});
...
class _UpdateTaskState extends State<UpdateTask> {
  ...
  String getStartDateDisplay(){
    return "  Start Time: " + widget.startTime;
  }

  String getEndDateDisplay(){
    return "  End Time: " + widget.endTime;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Editar Tarefa", style: TextStyle(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              //CRIAR TAREFA
              Center(
                child: ElevatedButton(onPressed: (false)
                      ? null
                      : () {
                  db.updateTask(widget.taskId, widget.nome, widget.note,  widget.startTime,  widget.endTime,  widget.date);
                  Navigator.pop(context);
